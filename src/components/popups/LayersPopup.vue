...
import { isLayerActive, toggleVectorLayer, togglePanoramaLayer,togglePanoramaLayer2 } from "@/modules/map";
      ...
      <div class="card">
        <div class="card-body px-2 py-1">
          <ul class="list-unstyled ps-0 mb-0">
            <li>
              <button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#aset" aria-expanded="true">Aset</button>
              <div class="collapse show" id="aset">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                  <li class="form-check" v-for="layer in layerList.assetkukar" :key="layer.id">
              ...
              <div class="collapse show" id="panorama-data">
                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                  <li class="form-check">
                    ...
                    <label class="form-check-label user-select-none" for="panorama">Panorama Lantai Ground</label>
                  </li>
                  <li class="form-check">
                    <input class="form-check-input" v-model="isLayerActive.panorama2" type="checkbox" value="panorama2" id="panorama2" @change="(evt) => togglePanoramaLayer2(evt, layer)" />
                    <label class="form-check-label user-select-none" for="panorama2">Panorama Lantai 1</label>
                  </li>
                </ul>
              </div>
            </li>
